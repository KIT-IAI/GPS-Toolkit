...
double MetersToUnits (long lUnits, double dblMeters)
{
    ...
    switch (lUnits)
    {
    case GPS_PROJECTION_UNITS_M:
        dblReturn /= 1.0;
        break;

    case GPS_PROJECTION_UNITS_KM:
        dblReturn /= 1000.0;
        break;

    case GPS_PROJECTION_UNITS_FT:
        dblReturn /= 0.3048;
        break;

    case GPS_PROJECTION_UNITS_FTBR:
        dblReturn /= 0.3048007491;
        break;

    case GPS_PROJECTION_UNITS_FTCLA:
        dblReturn /= 0.3047972654;
        break;

    case GPS_PROJECTION_UNITS_FTGC:
        dblReturn /= 0.304799710181509;
        break;

    case GPS_PROJECTION_UNITS_FTIND:
        dblReturn /= 0.304799510248147;
        break;

    case GPS_PROJECTION_UNITS_FTSE:
        dblReturn /= 0.304799471538676;
        break;

    case GPS_PROJECTION_UNITS_FTUS:
        dblReturn /= 0.304800609601219;
        break;

    case GPS_PROJECTION_UNITS_LK:
        dblReturn /= 0.201168;
        break;

    case GPS_PROJECTION_UNITS_LKCLA:
        dblReturn /= 0.201166195164;
        break;

    case GPS_PROJECTION_UNITS_LKSE:
        dblReturn /= 0.201167651215526;
        break;

    case GPS_PROJECTION_UNITS_LKUS:
        dblReturn /= 0.201168402336805;
        break;

    case GPS_PROJECTION_UNITS_MI:
        dblReturn /= 1609.344;
        break;

    case GPS_PROJECTION_UNITS_MIUS:
        dblReturn /= 1609.34721869444;
        break;

    case GPS_PROJECTION_UNITS_CH:
        dblReturn /= 20.1168;
        break;

    case GPS_PROJECTION_UNITS_CHCLA:
        dblReturn /= 20.1166195164;
        break;

    case GPS_PROJECTION_UNITS_CHBR:
        dblReturn /= 20.11678249437587;
        break;

    case GPS_PROJECTION_UNITS_CHSE:
        dblReturn /= 20.1167651215526;
        break;

    case GPS_PROJECTION_UNITS_CHUS:
        dblReturn /= 20.1168402336805;
        break;

    case GPS_PROJECTION_UNITS_YDIND:
        dblReturn /= 0.9143985307444408;
        break;

    case GPS_PROJECTION_UNITS_YDCLA:
        dblReturn /= 0.914391795;
        break;

    case GPS_PROJECTION_UNITS_GLM:
        dblReturn /= 1.0000135965;
        break;

    case GPS_PROJECTION_UNITS_YDSE:
        dblReturn /= 0.9143984146160287;
        break;
    }
