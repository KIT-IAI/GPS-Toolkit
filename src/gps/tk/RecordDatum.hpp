...
namespace gps
{
    namespace tk
    {
        ...
        public:
            ...
            void setInverseFlatting(double inverseFlatting)
            {
                dblInverseFlattening = inverseFlatting;
            }
            void setScale(double scale)
            {
                dblScaleFactor = scale;
            }
            void setPrimeMeridian(double primeMeridian)
            {
                dblPrimeMeridian = primeMeridian;
            }
