...
VOID CProjections::Forward ()
{
	...
	if ( ( IsSameDatum ( m_projSrc, m_projDst ) == FALSE ) && ( IsEllipsoidToSphere ( m_projSrc, m_projDst ) == FALSE ) )
	{
...
CProjection * CProjections::CreateProjection (CCfgMapProjection & proj)
{
	...
	{
		case GPS_PROJECTION_LAMBERT1SP:					pProj = new CProjectionLambert ();
			break;

		case GPS_PROJECTION_LAMBERT1SPWEST:				pProj = new CProjectionLambert ();
			break;

		case GPS_PROJECTION_LAMBERT2SP:					pProj = new CProjectionLambert ();
			break;

		case GPS_PROJECTION_LAMBERT2SPBELGIUM:			pProj = new CProjectionLambert ();
			break;

		case GPS_PROJECTION_LAMBERTAEA:					pProj = new CProjectionLambertAzimuthal ();
			break;

		case GPS_PROJECTION_ALBERSEQUALAREA:			pProj = new CProjectionAlbers ();
			break;

		case GPS_PROJECTION_MERCATOR1SP:				pProj = new CProjectionMercator ();
			break;

		case GPS_PROJECTION_MERCATOR2SP:				pProj = new CProjectionMercator ();
			break;

		case GPS_PROJECTION_TRANSVERSEMERCATOR:			pProj = new CProjectionTransverseMercator ();
			break;

		case GPS_PROJECTION_TRANSVERSEMERCATORSOUTH:	pProj = new CProjectionTransverseMercator ();
			break;

		case GPS_PROJECTION_OBLIQUEMERCATOR:			pProj = new CProjectionObliqueMercator ();
			break;

		case GPS_PROJECTION_HOTINEOBLIQUEMERCATOR:		pProj = new CProjectionObliqueMercator ();
			break;

		case GPS_PROJECTION_SWISSOBLIQUEMERCATOR:		pProj = new CProjectionSwissMercator ();
			break;

		case GPS_PROJECTION_STEREOGRAPHIC:				pProj = new CProjectionObliqueStereo ();
			break;
		
		case GPS_PROJECTION_POLARSTEREOGRAPHIC:			pProj = new CProjectionPolarStereo ();
			break;

		case GPS_PROJECTION_CASSINI:					pProj = new CProjectionCassiniSoldner ();
			break;

		case GPS_PROJECTION_KROVAK:						pProj = new CProjectionKrovak ();
			break;

		case GPS_PROJECTION_POLYCONIC:					pProj = new CProjectionPolyconic ();
			break;
	
		case GPS_PROJECTION_MOLLWEIDE:					pProj = new CProjectionMollweide ();
			break;

		case GPS_PROJECTION_ECKERTI:					pProj = new CProjectionEckert1 ();
			break;

		case GPS_PROJECTION_ECKERTII:					pProj = new CProjectionEckert2 ();
			break;
		
		case GPS_PROJECTION_ECKERTIII:					pProj = new CProjectionEckert3 ();
			break;

		case GPS_PROJECTION_ECKERTIV:					pProj = new CProjectionEckert4 ();
			break;
				
		case GPS_PROJECTION_ECKERTV:					pProj = new CProjectionEckert5 ();
			break;

		case GPS_PROJECTION_ECKERTVI:					pProj = new CProjectionEckert6 ();
			break;

		case GPS_PROJECTION_CYLINDRICALEQUALAREA:		pProj = new CProjectionCylEqArea ();
			break;

		case GPS_PROJECTION_SINUSOIDAL:					pProj = new CProjectionSinusoidal ();
			break;

		case GPS_PROJECTION_MILLER:						pProj = new CProjectionMiller ();
			break;

		case GPS_PROJECTION_BONNE:						pProj = new CProjectionBonne ();
			break;

		case GPS_PROJECTION_GALLSTEREOGRAPHIC:			pProj = new CProjectionGallStereo ();
			break;

		case GPS_PROJECTION_ROBINSON:					pProj = new CProjectionRobinson ();
			break;

		case GPS_PROJECTION_WINKELI:					pProj =  new CProjectionWinkel1 ();
			break;

		case GPS_PROJECTION_EQUIRECTANGULAR:			pProj = new CProjectionEquirectangular ();
			break;

		case GPS_PROJECTION_LOXIMUTHAL:					pProj = new CProjectionLoximuthal ();
			break;

		case GPS_PROJECTION_PLATECARREE:				pProj = new CProjectionPlateCarree ();
			break;

		case GPS_PROJECTION_GRINTENI:					pProj = new CProjectionGrinten1 ();
			break;

		case GPS_PROJECTION_ORTHOGRAPHIC:				pProj = new CProjectionOrthographic ();
			break;

		case GPS_PROJECTION_GNOMONIC:					pProj = new CProjectionGnomonic ();
			break;

		case GPS_PROJECTION_HAMMER:						pProj = new CProjectionHammer ();
			break;

		case GPS_PROJECTION_QUARTICAUTHALIC:			pProj = new CProjectionQuarticAuthalic ();
			break;

		case GPS_PROJECTION_AZIMUTHALEQUIDISTANT:		pProj = new CProjectionAzimuthalEq ();
			break;

		default:										pProj = new CProjection ();
			break;
	}
